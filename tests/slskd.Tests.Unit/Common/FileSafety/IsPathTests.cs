...
public class IsPath_MacOS
{
    public class Absolute
    {
        ...
        [InlineData("/")]
        [InlineData("/Users")]
        [InlineData("/Users/user/Music")]
        [InlineData("/Volumes/ExternalDrive")]
        [InlineData("/home/Ünïcödé")]
        [InlineData("/home/пользователь/Музыка")]
        [InlineData("//server/share")]
        [InlineData("//server/share/folder")]
        ...
        public void IsAbsolute_NotRelative(string path)
        {
            Assert.True(FileSafety.IsPathAbsolute(path, OSPlatform.OSX));
            Assert.False(FileSafety.IsPathRelative(path, OSPlatform.OSX));
        }
    }
    ...
    public class Relative
    {
        ...
        public void IsRelative_NotAbsolute(string path)
        {
            Assert.False(FileSafety.IsPathAbsolute(path, OSPlatform.OSX));
            Assert.True(FileSafety.IsPathRelative(path, OSPlatform.OSX));
        }
    }
}

public class IsPath_FreeBSD
{
    public class Absolute
    {
        [Theory]
        ...
        public void IsAbsolute_NotRelative(string path)
        {
            Assert.True(FileSafety.IsPathAbsolute(path, OSPlatform.FreeBSD));
            Assert.False(FileSafety.IsPathRelative(path, OSPlatform.FreeBSD));
        }
    }
    ...
    public class Relative
    {
        ...
        public void IsRelative_NotAbsolute(string path)
        {
            Assert.False(FileSafety.IsPathAbsolute(path, OSPlatform.FreeBSD));
            Assert.True(FileSafety.IsPathRelative(path, OSPlatform.FreeBSD));
        }
    }
}
