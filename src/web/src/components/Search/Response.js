...
export const Response = (props) => { 
    ...
    }, [props.response, props.isInitiallyFolded])

    /** Function to be called on download request, updates downloadRequest to 'inProgress', 'complete' on download completion, or 'error' when error is caught */
