...
namespace slskd
{
    ...
    public class Options
    {
        ...
        public class FlagsOptions
        {
            ...
            /// <summary>
            ///     Gets a value indicating whether to run in both controller and agent network modes.
            /// </summary>
            [Argument(default, "dual-network-mode")]
            [EnvironmentVariable("DUAL_NETWORK_MODE")]
            [Description("run in both controller and agent network modes")]
            [RequiresRestart]
            public bool DualNetworkMode { get; init; } = false;
        }
