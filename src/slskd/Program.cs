...
namespace slskd
{
    ...
    public static class Program
    {
        ...
        private static WebApplication ConfigureAspDotNetPipeline(this WebApplication app)
        {
            ...
            app.UseHTMLInjection($"<script>window.urlBase=\"{urlBase}\";window.port={OptionsAtStartup.Web.Port};window.defaultFilter=\"{OptionsAtStartup.Web.WebSearchFilter}\";</script>", excludedRoutes: new[] { "/api", "/swagger" });
